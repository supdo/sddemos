...
public class LoginActivity extends Activity {
	...
	public void attemptLogin() {
		...
		if (cancel) {
			...
			showProgress(true);
			mAuthTask = new UserLoginTask(this.mEmailView, this.mPasswordView);
	...
	public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
		...
		public UserLoginTask(EditText mEmail, EditText mPassword){
			super();
			this.mEmail = mEmail;
...
//			}
		...
		protected void onPostExecute(final Boolean success) {
			...
			if (success) {
				mLoginStatusMessageView.setText("登陆成功！");
				try {
					Thread.sleep(600);
				} catch (InterruptedException e) {
